...
<body>
	<div class="wrapper" style="margin: 30px 200px">
		<h1>News Add</h1>
		<form action="${pageContext.request.contextPath}/news/add"
			...
			<div class="form-group">
				...
				<textarea class="form-control" id="detail" placeholder="Detail"
					name="detail" rows="3"></textarea>
			</div>

			<div class="form-group">
				<label for="exampleInputEmail1">Picture</label> <input
					class="form-control" id="picture" name="pic" type="file">
			</div>
			<div class="form-group">
				<label for="exampleFormControlSelect1">Status</label> <select
					class="form-control" name="status" id="exampleFormControlSelect1">
